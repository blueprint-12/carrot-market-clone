  ...
  return (
    <WriteForm>
      ...
      <WriteBody>
        <ImageUpload>
          <label htmlFor="image">
            <Image1 src="https://png.pngtree.com/element_our/20190601/ourlarge/pngtree-file-upload-icon-image_1344393.jpg"
            alt="uploadBtn" 
            />
            
          </label><input name="image" type="file" asset="img/*" style={{display:"none"}}/>
            <Image1 src="https://dimg.donga.com/wps/NEWS/IMAGE/2022/01/28/111500268.2.jpg" 
            alt="previewImage"
            />
